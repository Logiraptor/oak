...
Elm.Application.make = function (_elm) {
   ...
   var Graph = F2(function (a,b) {    return {nodes: a,edges: b};});
   var Node = F2(function (a,b) {    return {process: a,position: b};});
   var Edge = F2(function (a,b) {    return {from: a,to: b};});
   return _elm.Application.values = {_op: _op,Edge: Edge,Node: Node,Graph: Graph,Port: Port,Process: Process};
};
Elm.Stage = Elm.Stage || {};
...
Elm.NodeRenderer.make = function (_elm) {
   "use strict";
   _elm.NodeRenderer = _elm.NodeRenderer || {};
   if (_elm.NodeRenderer.values) return _elm.NodeRenderer.values;
   var _U = Elm.Native.Utils.make(_elm),
   ...
   var formFlow = function (l) {
      var reducer = F2(function (next,_p0) {
         var _p1 = _p0;
         var _p2 = _p1._1;
         return {ctor: "_Tuple2",_0: A2($List._op["::"],A2($Graphics$Collage.moveY,_p2 - 20,next),_p1._0),_1: _p2 - 20};
      });
      var _p3 = A3($List.foldl,reducer,{ctor: "_Tuple2",_0: _U.list([]),_1: 20},l);
      var output = _p3._0;
      var height = _p3._1;
      return {ctor: "_Tuple2",_0: $Graphics$Collage.group(output),_1: 0 - height};
   };
   var formFromString = function (_p4) {    return $Graphics$Collage.toForm($Graphics$Element.centered($Text.fromString(_p4)));};
   var viewPort = function (p) {    return $Graphics$Collage.group(_U.list([A2($Graphics$Collage.filled,$Color.blue,$Graphics$Collage.circle(5))]));};
   var viewNode = function (n) {
      var _p5 = formFlow(A2($List.map,viewPort,n.process.outputs));
      var outputs = _p5._0;
      var oheight = _p5._1;
      var _p6 = formFlow(A2($List.map,viewPort,n.process.inputs));
      var inputs = _p6._0;
      var iheight = _p6._1;
      var height = A2($Basics.max,oheight,iheight);
      var _p7 = n.position;
      var x = _p7._0;
      var y = _p7._1;
      ...
      _U.list([formFromString(n.process.name)
              ...
              (0 - height) / 2,
              A2($Graphics$Collage.outlined,$Graphics$Collage.solid($Color.black),A2($Graphics$Collage.rect,150,height + 50)))
              ,A2($Graphics$Collage.moveX,-75,inputs)
              ,A2($Graphics$Collage.moveX,75,outputs)]));
   };
   var path = F2(function (_p9,_p8) {
      var _p10 = _p9;
      var _p15 = _p10._1;
      var _p14 = _p10._0;
      var _p11 = _p8;
      var _p13 = _p11._1;
      var _p12 = _p11._0;
      var midX = (_p12 + _p14) / 2;
      var points = _U.list([{ctor: "_Tuple2",_0: _p14,_1: _p15}
                           ,{ctor: "_Tuple2",_0: midX,_1: _p15}
                           ,{ctor: "_Tuple2",_0: midX,_1: _p13}
                           ,{ctor: "_Tuple2",_0: _p12,_1: _p13}]);
      return A2($Graphics$Collage.traced,$Graphics$Collage.defaultLine,$Graphics$Collage.path(points));
   });
   var get = F2(function (n,xs) {    return $List.head(A2($List.drop,n,xs));});
   var viewEdge = F2(function (g,e) {
      var _p16 = e.to;
      var j1 = _p16._0;
      var j2 = _p16._1;
      var to = A2($Maybe.withDefault,{position: {ctor: "_Tuple2",_0: 0,_1: 0},process: {name: "",inputs: _U.list([]),outputs: _U.list([])}},A2(get,j1,g.nodes));
      var _p17 = to.position;
      var toX = _p17._0;
      var toY = _p17._1;
      var _p18 = e.from;
      var i1 = _p18._0;
      var i2 = _p18._1;
      var from = A2($Maybe.withDefault,
      {position: {ctor: "_Tuple2",_0: 0,_1: 0},process: {name: "",inputs: _U.list([]),outputs: _U.list([])}},
      A2(get,i1,g.nodes));
      var _p19 = from.position;
      var fromX = _p19._0;
      var fromY = _p19._1;
      return A2(path,{ctor: "_Tuple2",_0: fromX + 75,_1: fromY - 20 * $Basics.toFloat(i2)},{ctor: "_Tuple2",_0: toX - 75,_1: toY - 20 * $Basics.toFloat(j2)});
   });
   return _elm.NodeRenderer.values = {_op: _op
                                     ,get: get
                                     ,viewEdge: viewEdge
                                     ,path: path
                                     ,viewNode: viewNode
