...
Elm.JsonToFunc = Elm.JsonToFunc || {};
Elm.JsonToFunc.make = function (_elm) {
   "use strict";
   _elm.JsonToFunc = _elm.JsonToFunc || {};
   if (_elm.JsonToFunc.values) return _elm.JsonToFunc.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var input = "\n  {\"name\": \"Patrick\"}\n  ";
   var Null = {ctor: "Null"};
   var nullDecoder = $Json$Decode.$null(Null);
   var Bool = function (a) {    return {ctor: "Bool",_0: a};};
   var boolDecoder = A2($Json$Decode.map,Bool,$Json$Decode.bool);
   var Float = function (a) {    return {ctor: "Float",_0: a};};
   var floatDecoder = A2($Json$Decode.map,Float,$Json$Decode.$float);
   var Int = function (a) {    return {ctor: "Int",_0: a};};
   var intDecoder = A2($Json$Decode.map,Int,$Json$Decode.$int);
   var String = function (a) {    return {ctor: "String",_0: a};};
   var stringDecoder = A2($Json$Decode.map,String,$Json$Decode.string);
   var Array = function (a) {    return {ctor: "Array",_0: a};};
   var Object = function (a) {    return {ctor: "Object",_0: a};};
   var buildObjectDecoder = function (_p0) {
      return A2($Json$Decode.andThen,
      $Json$Decode.succeed({ctor: "_Tuple0"}),
      function (_p1) {
         return A2($Json$Decode.map,Object,$Json$Decode.dict(buildDecoder(_p1)));
      });
   };
   var buildDecoder = function (_p2) {
      return $Json$Decode.oneOf(_U.list([buildObjectDecoder({ctor: "_Tuple0"})
                                        ,buildArrayDecoder({ctor: "_Tuple0"})
                                        ,stringDecoder
                                        ,intDecoder
                                        ,floatDecoder
                                        ,boolDecoder
   ...
   var buildArrayDecoder = function (_p3) {
      return A2($Json$Decode.andThen,
      $Json$Decode.succeed({ctor: "_Tuple0"}),
      function (_p4) {
         return A2($Json$Decode.map,Array,$Json$Decode.array(buildDecoder(_p4)));
      });
   };
   var arrayDecoder = buildArrayDecoder({ctor: "_Tuple0"});
   var decoder = buildDecoder({ctor: "_Tuple0"});
   var objectDecoder = buildObjectDecoder({ctor: "_Tuple0"});
   var stuff = A2($Json$Decode.decodeString,buildDecoder({ctor: "_Tuple0"}),input);
   var main = $Graphics$Element.show(stuff);
   return _elm.JsonToFunc.values = {_op: _op
                                   ,main: main
                                   ,stuff: stuff
                                   ,Object: Object
                                   ,Array: Array
                                   ...
                                   ,buildObjectDecoder: buildObjectDecoder
                                   ,buildArrayDecoder: buildArrayDecoder
                                   ,decoder: decoder
